...
//	ServiceNet    ServiceNet `json:"serviceNet"`    // 有:直接使用. 没有:使用 benchJson.ServiceNet
...
// Parse
// e.g.:/dawn/service/${zoneID}/${serviceName}/${serviceID}
// e.g.:/dawn/command/${zoneID}/${serviceName}/${serviceID}
// e.g.:/dawn/gm/${zoneID}/${serviceName}/${serviceID}
